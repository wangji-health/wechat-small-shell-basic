layui.use(['jquery', 'laydate'], function() {
	...
	$('.save').on('click', function() {
		...
		if(sessionStorage.babyNum == 1) {
			dataBaby = [{
				...
				"first_Inoculated_HBIG_Day": $('#hepatitisT').val(),
				"first_Inoculated_HBV_Day": $('#immunoglobulinT').val(),
			...
			dataBaby = [{
				...
				"first_HBIG_Day_Can_Be_Edited": 1,
				"first_HBV_Day_Can_Be_Edited": 1,
				"first_Inoculated_HBIG_Day": $('#hepatitisT2').val(),
				"first_Inoculated_HBV_Day": $('#immunoglobulinT2').val(),
				"second_HBV_Day_Can_Be_Edited": 1,
			...
			dataBaby = [{
				...
				"first_HBIG_Day_Can_Be_Edited": 1,
				"first_HBV_Day_Can_Be_Edited": 1,
				"first_Inoculated_HBIG_Day": $('#hepatitisT3').val(),
				"first_Inoculated_HBV_Day": $('#immunoglobulinT3').val(),
				"second_HBV_Day_Can_Be_Edited": 1,
	...
	$.ajax({
		...
		success: function(data) {
			...
			$('#hepatitisT').val(data.data[0].first_Inoculated_HBIG_Day);
			$('#immunoglobulinT').val(data.data[0].first_Inoculated_HBV_Day);
			$('#hepatitisTS').val(data.data[0].second_Inoculated_HBV_Day);
			$('#hepatitisTT').val(data.data[0].third_Inoculated_HBV_Day);

			if(data.data[1]) {
				$('#hepatitisT2').val(data.data[1].first_Inoculated_HBIG_Day);
				$('#immunoglobulinT2').val(data.data[1].first_Inoculated_HBV_Day);
				$('#hepatitisTS2').val(data.data[1].second_Inoculated_HBV_Day);
				$('#hepatitisTT2').val(data.data[1].third_Inoculated_HBV_Day);
			}

			if(data.data[2]) {
				$('#hepatitisT3').val(data.data[2].first_Inoculated_HBIG_Day);
				$('#immunoglobulinT3').val(data.data[2].first_Inoculated_HBV_Day);
			...
			if(firstChild.first_HBIG_Day_Can_Be_Edited == 0) {
				$('.first_img').hide();
			} else {
			...
			if(firstChild.first_HBV_Day_Can_Be_Edited == 0) {
				$('.second_img').hide();
			} else {
			...
			if(secondChild.first_HBIG_Day_Can_Be_Edited == 0) {
				$('.first_img2').hide();
			} else {
			...
			if(secondChild.first_HBV_Day_Can_Be_Edited == 0) {
				$('.second_img2').hide();
			} else {
			...
			if(thirdChild.first_HBIG_Day_Can_Be_Edited == 0) {
				$('.first_img3').hide();
			} else {
			...
			if(thirdChild.first_HBV_Day_Can_Be_Edited == 0) {
				$('.second_img3').hide();
			} else {
